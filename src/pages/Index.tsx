      ...
      <section className="bg-purple-soft py-16 md:py-20">
        <div className="container">
          <div className="mb-10 flex items-end justify-between">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link to="/qa" className="text-primary">
                هەموو ببینە
                <ArrowLeft className="mr-1 h-3.5 w-3.5" />
              </Link>
            </Button>
                ...
                <Card className="border-border transition-shadow hover:shadow-sm">
                  <CardContent className="flex items-start gap-4 p-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold text-foreground leading-snug hover:text-primary transition-colors cursor-pointer">
                        {q.title}
                      </h3>
      ...
      <section className="bg-primary py-16 md:py-20">
        <div className="container text-center">
          <h2 className="text-2xl font-bold text-primary-foreground md:text-3xl">
            ئامادەیت ببیتە بەشێک لە کۆمەڵگاکە؟
          </h2>
          <p className="mx-auto mt-3 max-w-lg text-sm text-primary-foreground/80 leading-relaxed">
            ئێستا تۆمار بکە و پڕۆژەکانت بنێرە، پرسیار بکە، و بابەت بنووسە.
          </p>
