  ...
  return (
    <div className="py-10 md:py-14">
      <div className="container">
        ...
        {featured && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.25, 0.1, 0.25, 1] }} className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <CardContent className="flex flex-col justify-center p-6 md:p-8">
                  ...
                  <div className="mt-5 flex items-center gap-4 text-xs text-muted-foreground">
                    ...
                    <span className="flex items-center gap-1"><Calendar className="h-3 w-3" />{featured.created_at}</span>
                    <span className="flex items-center gap-1"><Eye className="h-3 w-3" />{featured.views_count.toLocaleString("ar-SA")}</span>
                  </div>
                </CardContent>
              </div>
            </Card>
